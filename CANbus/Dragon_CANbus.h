...
#    define INC_DRAGON_CANBUS_H_
    ...
    ******************************************************************************************************************
    ...
    main{
     ...
     if (CAN1bus_SendData(CANgen_ID_TEMPERATURE, 2, CAN_RTR_DATA | CANdef_, aData) != HAL_OK){
    //send data Error_Handler();
     }
...
#    if (defined(STM32F413xx) || defined(STM32F403xx))
...
//    #define _CANgen_USED_TEMPERATURE   /*example*/
    ...
    //#define __CAN1_FILTERLIST  _dragon_CANbus_filterList_ESP_gen           //ESP - CAN_gen
    //#define __CAN1_FILTERLIST  _dragon_CANbus_filterList_HV_gen            //HV - CAN_gen
    //#define __CAN1_FILTERLIST  _dragon_CANbus_filterList_PEDAL_crit        //PEDAL - CAN_crit
    //#define __CAN1_FILTERLIST  _dragon_CANbus_filterList_AMSM_crit         //AMSM - CAN_crit
...
//    #define __CAN2_FILTERLIST  _dragon_CANbus_filterList_VCU_gen           //VCU - CAN_gen
    ...
    //#define __CAN2_FILTERLIST  _dragon_CANbus_filterList_ESP_gen           //ESP - CAN_gen
    //#define __CAN2_FILTERLIST  _dragon_CANbus_filterList_HV_gen            //HV - CAN_gen
    //#define __CAN2_FILTERLIST  _dragon_CANbus_filterList_PEDAL_crit        //PEDAL - CAN_crit
    //#define __CAN2_FILTERLIST  _dragon_CANbus_filterList_AMSM_crit         //AMSM - CAN_crit
...
#        define _CAN1def_ONLY_INTERRUPT_MODE
#        define _CAN2def_ONLY_INTERRUPT_MODE
#        define __CAN1_CANgenBus // CAN_crit
#        define __CAN1_FILTERLIST _dragon_CANbus_filterList_ESP_gen
#        define __CAN2_CANcritBus // CAN_ams
#        define __CAN2_FILTERLIST _dragon_CANbus_filterList_ESP_crit
#    endif
...
#    endif //_DUAL_CAN_ACTIVATE
     ...
     * @note If you use EXTENDED ID call both functions
     * (CANbus_FilterInit,CANbus_ExtendedFilterInit)
     * @param None
     * @return Status (value of @ref HAL_StatusTypeDef)
     */
...
#    endif //_DUAL_CAN_ACTIVATE
     ...
     */
    HAL_StatusTypeDef CAN1bus_SendData(uint16_t msgID, size_t msgSize, uint16_t msgCnf,
                                       uint8_t aData[]);
...
#    ifdef _DUAL_CAN_ACTIVATE
    HAL_StatusTypeDef CAN2bus_SendData(uint16_t msgID, size_t msgSize, uint16_t msgCnf,
                                       uint8_t aData[]);
#    endif //_DUAL_CAN_ACTIVATE
