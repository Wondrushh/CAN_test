...
#define __weak   __attribute__((weak))
    ...
    #define __EXTENDET_CAN_ACTIVATE
#endif
...
const uint16_t _dragon_CANbus_filterList_VCU_crit[14][6] = {
    {0x0000u, 0x007Cu, 0x07FEu, 0x012Cu, 0x0001u, 0x0001u},    //  0   Filtr Bank
...
const uint16_t _dragon_CANbus_filterList_AMSS_ams[14][6] = {
    {0x07feu, 0x0002u, 0x07ffu, 0x0076u, 0x0001u, 0x0001u}, //  0   Filtr Bank
    {0x07ffu, 0x0080u, 0x07ffu, 0x008au, 0x0001u, 0x0001u}, //  1   Filtr Bank
    {0x07ffu, 0x0094u, 0x07ffu, 0x009eu, 0x0001u, 0x0001u}, //  2   Filtr Bank
    {0x07ffu, 0x00a8u, 0x07ffu, 0x0013u, 0x0001u, 0x0001u}, //  3   Filtr Bank
    {0x07ffu, 0x001fu, 0x07fcu, 0x0020u, 0x0001u, 0x0001u}, //  4   Filtr Bank
    {0x07ffu, 0x0024u, 0x07ffu, 0x0000u, 0x0001u, 0x0001u}, //  5   Filtr Bank
    {0x07ffu, 0x0000u, 0x07ffu, 0x0000u, 0x0000u, 0x0000u}, //  6   Filtr Bank
    {0x07ffu, 0x0000u, 0x07ffu, 0x0000u, 0x0000u, 0x0000u}, //  7   Filtr Bank
    {0x07ffu, 0x0000u, 0x07ffu, 0x0000u, 0x0000u, 0x0000u}, //  8   Filtr Bank
    {0x07ffu, 0x0000u, 0x07ffu, 0x0000u, 0x0000u, 0x0000u}, //  9   Filtr Bank
